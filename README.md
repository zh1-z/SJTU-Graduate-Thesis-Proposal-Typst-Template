...
[![Typst Package](https://img.shields.io/badge/Typst-Package-239DAD)](https://typst.app/universe/package/std-sjtu-graduate-thesis-proposal)
...
3. 搜索框输入 `std-sjtu-graduate-thesis-proposal`
...
3. 在模板库中搜索 `std-sjtu-graduate-thesis-proposal`
